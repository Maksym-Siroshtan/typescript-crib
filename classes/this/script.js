...
console.log("Результат получения на объекте юзер. Контекст потерян: ", user4.paymentDate()); // Undefined - контекст потерян, но TS не подсказывает
...
const user5 = {
    id: 1,
    paymentDate: payment5.getDate.bind(payment5),
