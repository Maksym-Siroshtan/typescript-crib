...
interface ISubject {
  // Тот кто имитит событие, и к кому можно подписаться
  attach(observer: IObserver): void; // Прикрепить
  detach(observer: IObserver): void; // Открепить
...
subject.state = new Lead("John", "12345");
